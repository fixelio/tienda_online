...
<h1>Tienda Online</h1>
    ...
    <div class="contenedor">
      <form class="row g-3" method="POST" action="modificar.php">
        <div class="col-4">
          <label for="nombre" class="form-label">Marca</label>
          <input type="text" class="form-control" id="marca" name="marca" aria-describedby="emailHelp"value="<?php echo $_GET['marca']; ?>">
        </div>
        <div class="col-4">
          <label for="nombre" class="form-label">Modelo</label>
          <input type="text" class="form-control" id="modelo" name="modelo" aria-describedby="emailHelp"value="<?php echo $_GET['modelo']; ?>">
        </div>
        <div class="col-4">
          <label for="precio" class="form-label">Precio del producto</label>
          <input type="number" class="form-control" id="precio" name="precio" value="<?php echo $_GET['precio']; ?>">
        </div>
        <div class="col-12">
          <label for="url" class="form-label">Enlace a la imagen</label>
          <input type="text" class="form-control" id="url" name="url"value="<?php echo $_GET['url']; ?>">
        </div>
        <div class="col-12">
          <label for="descripcion" class="form-label">Descripción del producto</label>
          <textarea name="descripcion" id="descripcion" class="form-control" cols="30" rows="10"value=""><?php echo $_GET['descripcion']; ?></textarea>
        </div>
        <div class="col-12">
          <label for="id_computadora" class="form-label">ID</label>
          <input type="text" class="form-control" id="id_computadora" name="id_computadora" aria-describedby="emailHelp"value="<?php echo $_GET['id_computadora']; ?>"readonly>
        </div>
        <!--<div class="col-12">
